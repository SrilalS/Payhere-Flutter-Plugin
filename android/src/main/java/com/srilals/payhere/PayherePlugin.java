...
public class PayherePlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    if (call.method.equals("PAY")) {
      ...
      payhereOTP.onTimePayment(result, MID, MSecret, Currency, Amount, OrderID, ItemDesc, CM1, CM2, FName, LName, Email, Phone, Address, City, Country, DeliveryAddress, DeliveryCity, DeliveryCountry, Quantity, MODE);
